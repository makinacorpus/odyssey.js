  ...
  d3.xhr(template + ".html").get(function(err, xhr) {
    ...
    d3.xhr('https://api.github.com/gists')
      ...
      .post(JSON.stringify(payload), function(err, xhr) {
        ...
        var BLOCKS = 'http://editor-o.makina-corpus.net/';
        // console.log(gist);
        callback({
          url: gist.url,
